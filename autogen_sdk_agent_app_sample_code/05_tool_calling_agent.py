...
os.environ["DATABRICKS_HOST"] = host_name
...
agents.deploy(agent_storage_config.uc_model_name, uc_registered_model_info.version, environment_vars={"DATABRICKS_HOST": host_name, "DATABRICKS_TOKEN": token})
...
os.environ["MLFLOW_AUTOLOGGING"] = "False"
